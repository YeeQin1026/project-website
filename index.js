...
function displayItems(){
    ...
    const puddingData= foodItem.filter((item)=>item.category=='Pudding');
    const biscuitData= foodItem.filter((item)=>item.category=='Biscuit');
    const soupData= foodItem.filter((item)=>item.category=='Soup');
    const bubbleteaData= foodItem.filter((item)=>item.category=='Bubble Tea');
    ...
    puddingData.map(item=>{
        ...
        pudding.appendChild(itemCard)

    })

    biscuitData.map(item=>{
        var itemCard= document.createElement('div');
        itemCard.setAttribute('id','item-card')
    ...
    bubbleteaData.map(item=>{
        ...
        bubbletea.appendChild(itemCard)
...
const cakeData= [...new Map(foodItem.map(item=> [item['category'],item])).values()];
